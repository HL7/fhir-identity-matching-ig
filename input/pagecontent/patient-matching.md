...
| **Minimum Included Attributes**                     | **Attribute Verification in B2B TPO Workflow** (PHI or PII to HIPAA Covered Entity)               | **Attribute Verification in App-Mediated B2B with Patient User Workflow** (PHI or PII to non-HIPAA Covered Entity)     |
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
