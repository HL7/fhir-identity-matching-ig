...
>      - US state- or nationally-issued photo ID confirmed by comparison to individual plus mobile number verified as billed to the individual  
>  - Declaration of Identity attestation by the individual indicates that all submitted information including first name, last name, date of birth, and home street address represents their own identity. 
>  - Verify the individual's physical residential Address of Record. Address confirmation **SHALL** be performed as per section 4.4.1.6 of NIST SP 800-63-3A with the following changes: 
>      - Notification of proofing, including an email or telephone contact information for the Identity Provider, **SHALL** be sent either by postal mail to the verified Address of Record or sent via SMS to the mobile number verified as billed to the individual by name. (Mobile number verification means the number appears on a bill including the individual's name that is submitted as identity evidence and is consistent with other evidence.)
>
> **IDIAL2** requirements: 
